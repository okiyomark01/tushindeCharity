            ...
            <div className="w-full px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        {storyName
                            ? `Your donation will directly support ${storyName}.`
                            ...
                            <div className="bg-green-50 border border-green-200 rounded-xl p-8 text-center animate-fade-in mb-8">
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <p className="text-4xl font-bold text-gray-900">{paybill}</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-2xl font-bold text-gray-900">{account}</p>
                                    </div>
                                </div>
                                ...
                                <div className="mt-8 bg-white p-4 rounded-lg border border-green-100 text-left max-w-md mx-auto">
                                    ...
                                    <ol className="list-decimal list-inside space-y-2 text-sm text-gray-600">
                                        ...
                                        <li>Enter Account No: <strong>{account}</strong></li>
